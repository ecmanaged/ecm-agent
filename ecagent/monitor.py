...
class ECMMonitor():
    ...
    def monitor_get(self, *argv, **kwargs):
        """
    ...
    def monitor_plugin_install(self, *argv, **kwargs):
        """
    ...
    def monitor_plugin_uninstall(self, *argv, **kwargs):
        """
...
def _run_background_file(script, run_as=None):
    ...
    try:
        ...
        # FIXME (add __mplugin paht???)
        # env['PYTHONPATH'] = MY_MONITOR_PATH + ':' + env.get('PYTHONPATH', '')
