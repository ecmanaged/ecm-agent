...
Requires: python2 python-devel pygobject3 PackageKit PolicyKit dbus-python python-twisted-core python-twisted-web python-protocols python-configobj python-twisted-words python-psutil libxml2-python python-simplejson rpm-python python-crypto python-httplib2 python-pip
